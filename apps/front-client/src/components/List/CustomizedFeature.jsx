    ...
    return (
        <div className="customized-list w-[100%]">
            ...
            <div className="list-body">
                ...
                <div className="list-body-content lg:text-[18px] md:text-[17px] sm:text-[15px]">
            ...
            {openModal && <DetailedFeatureModal row={props.data} refreshData={props.refreshData} openModal={openModal} closeModal={()=>setOpenModal(false)}></DetailedFeatureModal>}
        </div>
    )
}
