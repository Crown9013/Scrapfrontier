              ...
              <SwiperSlide key={index} className="w-[100%]">
                <div className="flex flex-col">
                  <img
                    ...
                    alt=""
                  />
                  <span className="relative bg-[#CC402A] text-white p-2  text-center lg:text-[18px] md:text-[12px] sm:text-[12px] lg:text-[18px] uppercase w-[50%] -mt-[20px] lg:-mt-[40px] md:-mt-[40px] sm:-mt-[40px]">
                    tournament
                  </span>
