                ...
                <table className="w-[100%]">
                    ...
                    <tbody className="w-[100%] h-[30vh]" style={{position:"relative", top:"30px"}}>
                        <tr className="grid grid-cols-12 p-4" style={{backgroundColor:"rgba(255,255,255,0.02)"}}>
                            <td className="col-span-2 lg:py-2 md:py-3 sm:py-4 flex flex-row lg:text-left md:text-left sm:text-center">
                            ...
                            <td className="col-span-4 lg:float-left md:float-left sm:text-center">
